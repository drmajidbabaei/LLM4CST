# LLM4CST
**A repository of research and materials on LLMs for Continuous Software Testing within a DevOps framework.** 
...
- [LLM4CST](#llm4cst)
  ...
  - [Related Publications](#related-publications)
    - [Continuous Software Testing in Continuous Integeration](#continuous-software-testing-in-continuous-integeration)
      - [Software Testing Objectives](#software-testing-objectives)
      - [Software Testing Activities](#software-testing-activities)
      - [Software Testing Techniques](#software-testing-techniques)
    - [Continuous Software Testing in Continuous Delivery](#continuous-software-testing-in-continuous-delivery)
      - [Software Testing Objectives](#software-testing-objectives-1)
      - [Software Testing Activities](#software-testing-activities-1)
      - [Software Testing Techniques](#software-testing-techniques-1)
    - [Continuous Software Testing in Continuous Deployment](#continuous-software-testing-in-continuous-deployment)
      - [Software Testing Objectives](#software-testing-objectives-2)
      - [Software Testing Activities](#software-testing-activities-2)
      - [Software Testing Techniques](#software-testing-techniques-2)
...
We encourage contributions to this repository. Please submit a pull request to include any missing papers or related content. Detailed paper listings and in-depth analyses of the research questions (RQs) can be found in [HERE](https://LINK).
...
```
@article{TEST,
  title={Large language models for continuous software testing within a DevOps framework: A systematic literature review},
  author={TBA},
...
### Continuous Software Testing in Continuous Integeration
#### Software Testing Objectives
####  Software Testing Activities
#### Software Testing Techniques
<!-- ------------------------------------------------------ -->
### Continuous Software Testing in Continuous Delivery
#### Software Testing Objectives
####  Software Testing Activities
#### Software Testing Techniques
<!-- ------------------------------------------------------ -->

### Continuous Software Testing in Continuous Deployment
#### Software Testing Objectives
####  Software Testing Activities
#### Software Testing Techniques
